...
export const getLabel = (keycodeByte, width, macros, selectedDefinition, basicKeyToByte, byteToKey) => {
  var _a, _b;
  let label = "";
  if (isCustomKeycodeByte(keycodeByte, basicKeyToByte) && ((_a = selectedDefinition == null ? void 0 : selectedDefinition.customKeycodes) == null ? void 0 : _a.at(getCustomKeycodeIndex(keycodeByte, basicKeyToByte))) !== void 0) {
    const customKeycodeIdx = getCustomKeycodeIndex(keycodeByte, basicKeyToByte);
    label = getShortNameForKeycode(selectedDefinition.customKeycodes[customKeycodeIdx]);
  } else if (keycodeByte) {
    label = (_b = getLabelForByte(keycodeByte, width * 100, basicKeyToByte, byteToKey)) != null ? _b : "";
  }
  let macroExpression;
